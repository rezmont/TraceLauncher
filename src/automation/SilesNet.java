 ...
 * @author motamedi
 */
public class SilesNet extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(SilesNet.class.getName()).log(Level.SEVERE, null, ex);
