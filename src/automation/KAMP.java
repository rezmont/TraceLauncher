 ...
 * @author motamedi
 */
public class KAMP extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://www.kamp-lookingglass.de/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Document doc = c.post();
			result = doc.getElementsByTag("pre").first().html().replace("\n\n", "\n");
