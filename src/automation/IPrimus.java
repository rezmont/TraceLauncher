 ...
 * @author motamedi
 */
public class IPrimus extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://looking-glass.iprimus.net.au/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(IPrimus.class.getName()).log(Level.SEVERE, null, ex);
