 ...
 * @author motamedi
 */
public class SolNet extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(SolNet.class.getName()).log(Level.SEVERE, null, ex);
