 ...
 * @author motamedi
 */
public class XMission extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "https://stats.xmission.com/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(XMission.class.getName()).log(Level.SEVERE, null, ex);
