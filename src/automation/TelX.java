 ...
 * @author motamedi
 */
public class TelX extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://tieatl-server1.telx.com/lg.pl";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(TelX.class.getName()).log(Level.SEVERE, null, ex);
