 ...
 * @author motamedi
 */
public class HGCIntl extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.ibeo.hgc-intl.com/cgi-bin/flg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(HGCIntl.class.getName()).log(Level.SEVERE, null, ex);
