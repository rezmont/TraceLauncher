 ...
 * @author motamedi
 */
public class BelWue extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://www.belwue.de/lg/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(BelWue.class.getName()).log(Level.SEVERE, null, ex);
