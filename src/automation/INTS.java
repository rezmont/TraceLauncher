 ...
 * @author motamedi
 */
public class INTS extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.ints.net/cgi-bin/lg.pl";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(INTS.class.getName()).log(Level.SEVERE, null, ex);
