 ...
 * @author motamedi
 */
public class iiNet extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://looking-glass.iinet.net.au/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(iiNet.class.getName()).log(Level.SEVERE, null, ex);
