 ...
 * @author motamedi
 */
public class HBONE extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://diag.vh.hbone.hu/lookingglass/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(HBONE.class.getName()).log(Level.SEVERE, null, ex);
