 ...
 * @author motamedi
 */
public class Nordu extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://stats.nordu.net/looking-glass/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Nordu.class.getName()).log(Level.SEVERE, null, ex);
