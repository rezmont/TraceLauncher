 ...
 * @author motamedi
 */
public class Emix extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.emix.net.ae/lg";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Emix.class.getName()).log(Level.SEVERE, null, ex);
