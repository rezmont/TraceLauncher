 ...
 * @author motamedi
 */
public class Clearfly extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.clearfly.net/cgi-bin/bgplg?cmd=traceroute&req=";
	...
	public String launch() {
		try {
			...
			Logger.getLogger(Clearfly.class.getName()).log(Level.SEVERE, null, ex);
