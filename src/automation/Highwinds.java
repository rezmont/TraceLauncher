 ...
 * @author motamedi
 */
public class Highwinds extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lookingglass.hwng.net/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(KPN.class.getName()).log(Level.SEVERE, null, ex);
