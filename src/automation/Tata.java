 ...
 * @author motamedi
 */
public class Tata extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.as6453.net/bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Tata.class.getName()).log(Level.SEVERE, null, ex);
