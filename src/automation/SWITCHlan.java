 ...
 * @author motamedi
 */
public class SWITCHlan extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.lan.switch.ch/lg/6lg.cgi/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(SWITCHlan.class.getName()).log(Level.SEVERE, null, ex);
