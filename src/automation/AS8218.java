 ...
 * @author motamedi
 */
public class AS8218 extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(AS8218.class.getName()).log(Level.SEVERE, null, ex);
