 ...
 * @author motamedi
 */
public class MTC extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.mtu.ru/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(MTC.class.getName()).log(Level.SEVERE, null, ex);
