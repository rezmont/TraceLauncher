 ...
 * @author motamedi
 */
public class GlobalCrossing extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://ipstats.globalcrossing.net/cgi-bin/lg/lg.cgi?lgCall=r2htrace";
	...
	public String launch() {
		try {
			...
			c.data("source", locVar);
                        c.data("lgCall", "r2htrace");
			c.data("destAddress", dstIP);
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(GlobalCrossing.class.getName()).log(Level.SEVERE, null, ex);
