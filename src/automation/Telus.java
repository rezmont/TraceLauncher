...
public class Telus extends Launcher implements LauncherInterface {
	...
	public Telus(String line, String folder) {
		super(line, folder);
	}
	...
	public void setUp() throws Exception {
		...
		baseUrl = "http://aurora.on.tac.net/";
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	}

	@Test
	public void testTelus() throws Exception {
		driver.get(baseUrl);
	...
	public String launch() {
		try {
			...
			Logger.getLogger(Telus.class.getName()).log(Level.SEVERE, null, ex);
		}
		return result;
	}
}
