 ...
 * @author motamedi
 */
public class DTS extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.dts-online.net/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(DTS.class.getName()).log(Level.SEVERE, null, ex);
