 ...
 * @author motamedi
 */
public class Vibe extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.vibecommunications.co.nz/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Vibe.class.getName()).log(Level.SEVERE, null, ex);
