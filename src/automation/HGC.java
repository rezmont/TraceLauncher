 ...
 * @author motamedi
 */
public class HGC extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://traceroute.hgc.com.hk/cgi-bin/nph-traceroute";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(HGC.class.getName()).log(Level.SEVERE, null, ex);
