 ...
 * @author motamedi
 */
public class TPNET extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.tpnet.pl/cgi-bin/lg.pl";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(TPNET.class.getName()).log(Level.SEVERE, null, ex);
