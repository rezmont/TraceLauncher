 ...
 * @author motamedi
 */
public class ForeThought extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://noc.forethought.net/debug/netcheck.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(ForeThought.class.getName()).log(Level.SEVERE, null, ex);
