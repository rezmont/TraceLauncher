 ...
 * @author motamedi
 */
public class BREN extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://netmon.acad.bg/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(BREN.class.getName()).log(Level.SEVERE, null, ex);
