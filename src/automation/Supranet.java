 ...
 * @author motamedi
 */
public class Supranet extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.supranet.net/lg/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Supranet.class.getName()).log(Level.SEVERE, null, ex);
