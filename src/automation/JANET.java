 ...
 * @author motamedi
 */
public class JANET extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.ja.net/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(JANET.class.getName()).log(Level.SEVERE, null, ex);
