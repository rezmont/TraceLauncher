 ...
 * @author motamedi
 */
public class TWTelecom extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lglass.twtelecom.net/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(TWTelecom.class.getName()).log(Level.SEVERE, null, ex);
