 ...
 * @author motamedi
 */
public class AAPT extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://looking-glass.connect.com.au/lg";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(AAPT.class.getName()).log(Level.SEVERE, null, ex);
