 ...
 * @author motamedi
 */
public class UNINETT extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://drift.uninett.no/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(UNINETT.class.getName()).log(Level.SEVERE, null, ex);
