 ...
 * @author motamedi
 */
public class Steadfast extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://www.steadfast.net/support/networktest.php#lghead";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Steadfast.class.getName()).log(Level.SEVERE, null, ex);
