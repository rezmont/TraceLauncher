 ...
 * @author motamedi
 */
public class RNP extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(RNP.class.getName()).log(Level.SEVERE, null, ex);
