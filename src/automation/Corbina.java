 ...
 * @author motamedi
 */
public class Corbina extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Corbina.class.getName()).log(Level.SEVERE, null, ex);
