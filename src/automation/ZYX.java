 ...
 * @author motamedi
 */
public class ZYX extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://traceroute.zyx.ro/index.php";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(ZYX.class.getName()).log(Level.SEVERE, null, ex);
