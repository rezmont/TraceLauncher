 ...
 * @author motamedi
 */
public class RedIRIS extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://www.rediris.es/red/lg/lg.pl";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(RedIRIS.class.getName()).log(Level.SEVERE, null, ex);
