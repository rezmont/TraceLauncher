 ...
 * @author motamedi
 */
public class Towardex extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://www.towardex.com/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Towardex.class.getName()).log(Level.SEVERE, null, ex);
