 ...
 * @author motamedi
 */
public class BBOI extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://irr.bboi.net/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(BBOI.class.getName()).log(Level.SEVERE, null, ex);
