 ...
 * @author motamedi
 */
public class ASDASD extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(ASDASD.class.getName()).log(Level.SEVERE, null, ex);
