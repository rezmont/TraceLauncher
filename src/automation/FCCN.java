 ...
 * @author motamedi
 */
public class FCCN extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.ip6.fccn.pt/cgi-bin/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(FCCN.class.getName()).log(Level.SEVERE, null, ex);
