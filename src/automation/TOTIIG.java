 ...
 * @author motamedi
 */
public class TOTIIG extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://www.totiig.net/lg";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(TOTIIG.class.getName()).log(Level.SEVERE, null, ex);
