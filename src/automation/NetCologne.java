 ...
 * @author motamedi
 */
public class NetCologne extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://plg.netcologne.de/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(NetCologne.class.getName()).log(Level.SEVERE, null, ex);
