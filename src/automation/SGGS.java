 ...
 * @author motamedi
 */
public class SGGS extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(SGGS.class.getName()).log(Level.SEVERE, null, ex);
