 ...
 * @author motamedi
 */
public class Telia extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Telia.class.getName()).log(Level.SEVERE, null, ex);
