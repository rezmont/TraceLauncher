 ...
 * @author motamedi
 */
public class Noris extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "https://www.noris.net/cgi-bin/lg/lg.cgi";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Noris.class.getName()).log(Level.SEVERE, null, ex);
