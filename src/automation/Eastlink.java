 ...
 * @author motamedi
 */
public class Eastlink extends Launcher implements LauncherInterface {
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Eastlink.class.getName()).log(Level.SEVERE, null, ex);
