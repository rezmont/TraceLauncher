 ...
 * @author motamedi
 */
public class DoclerWeb extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://www.docler.net/lg/";
	...
	public String launch() {
		try {
			...
			c.referrer("http://www.docler.net/lg/");
			c.timeout(100000);
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(DoclerWeb.class.getName()).log(Level.SEVERE, null, ex);
