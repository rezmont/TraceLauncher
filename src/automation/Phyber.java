...
public class Phyber extends Launcher implements LauncherInterface {
	...
	public Phyber(String line, String folder) {
		super(line, folder);
	}
	...
	public void setUp() throws Exception {
		...
		baseUrl = "http://lg.phyber.com/cgi-bin/bgplg";
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	}

	@Test
	public void testPhyber() throws Exception {
		driver.get(baseUrl);
	...
	public String launch() {
		try {
			...
			Logger.getLogger(Phyber.class.getName()).log(Level.SEVERE, null, ex);
		}
		return result;
	}
}
