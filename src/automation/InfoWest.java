 ...
 * @author motamedi
 */
public class InfoWest extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.infowest.net/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(InfoWest.class.getName()).log(Level.SEVERE, null, ex);
