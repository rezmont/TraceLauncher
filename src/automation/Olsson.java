 ...
 * @author motamedi
 */
public class Olsson extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://coyote.olsson.net/lg/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Olsson.class.getName()).log(Level.SEVERE, null, ex);
