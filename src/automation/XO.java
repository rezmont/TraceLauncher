 ...
 * @author motamedi
 */
public class XO extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://xostats.xo.com/cgi-bin/xostats/diagtool-pub/trace";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			System.out.println("\n\n #### xo!! sleep 1 minute to avoid block  #### ");
