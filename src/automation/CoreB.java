 ...
 * @author motamedi
 */
public class CoreB extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://lg.core-backbone.com/ajax.php";
	...
	public String launch() {
		try {
			...
			Logger.getLogger(CoreB.class.getName()).log(Level.SEVERE, null, ex);
