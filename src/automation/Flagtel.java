 ...
 * @author motamedi
 */
public class Flagtel extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://ubs.flagtel.com/lg";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Flagtel.class.getName()).log(Level.SEVERE, null, ex);
