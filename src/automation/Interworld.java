 ...
 * @author motamedi
 */
public class Interworld extends Launcher implements LauncherInterface {
	...
	public void config(String line, String folder) {
		result = "fail";
		baseUrl = "http://www.interworld.net/cgi-bin/nph-traceroute.cgi/";
...
//			c.header("Content-Type", "application/x-www-form-urlencoded");
			...
			Logger.getLogger(Interworld.class.getName()).log(Level.SEVERE, null, ex);
